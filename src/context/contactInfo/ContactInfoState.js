...
const ContactInfoState = (props) => {
	...
	const [contactInfo] = useState([
		...
		{ icon: 'fa-brands fa-twitter', name: 'Twitter', title: 'omkar__ghodake', url: 'https://twitter.com/omkar__ghodake' },
		{ icon: 'fa-brands fa-telegram', name: 'Telegram', title: 'omkar_ghodake', url: 'https://t.me/omkar_ghodake' },
		{ icon: 'fa-brands fa-instagram', name: 'Instagram', title: '_omkar.ghodake_', url: 'https://www.instagram.com/_omkar.ghodake_/' },
