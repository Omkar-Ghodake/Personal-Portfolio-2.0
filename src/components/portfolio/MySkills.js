		...
		<>
			<div className="my-skills mb-4">
				...
				<div className="row skills-card justify-content-center bg-dark border-12 justify-content-center align-items-center p-2 card-shadow">
					{
						skillImgs.map((image) => {
							return <div key={image.title} className="col-md-6">
								<div className="row justify-content-center align-items-center">
									...
									<div className="col-7">
										<div className="progress">
											<div className="progress-bar" role="progressbar" style={{ width: (image.width + '%') }} aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">{image.width}%</div>
										</div>
									</div>
								</div>
							</div>
