				...
				<div className="container-fluid"><button className="navbar-toggler" type="button" data-bs-toggle="collapse"
					...
					<div className="collapse navbar-collapse" id="navbarSupportedContent">
						...
						<div className="d-flex theme-icon-contain align-items-center">
							{
								theme === 'light' ? <i className="fa-solid fa-moon theme-icon nav-item rounded-circle d-flex justify-content-center align-items-center" onClick={ toggleTheme }></i> : <i className="fa-solid fa-sun theme-icon nav-item rounded-circle d-flex justify-content-center align-items-center" onClick={ toggleTheme }></i>
							}
						</div>
					</div>
				</div>
